...
public class SoundManager
{
    ...
    public final static Clip[] clips = {bangLarge, bangMedium, bangSmall, beat1, beat2, extraShip, fire, saucerBig, saucerSmall, thrust};
    ...
    public static void asteroidsLarge()
    {
        play(bangLarge);
    }

    public static void asteroidsMedium()
    {
        play(bangMedium);
    }

    public static void asteroidsSmall()
    {
        play(bangSmall);
    }
